...
const STORES: SeedStore[] = [
  {
    ...
    products: [
      ...
      { name: 'Benguet Coffee Beans (250g)', brand: 'Cordillera', price: 320, category: 'Beverages', stock: 30 },
    ],
  },
  {
  ...
  },
  {
    ...
    products: [
      ...
      { name: 'USB-C Fast Charger 30W', brand: 'Aukey', price: 690, category: 'Mobile Phones', stock: 60 },
      { name: 'Power Bank 20000mAh', brand: 'Anker', price: 1450, category: 'Mobile Phones', stock: 35 },
  ...
  },
  {
    ...
    products: [
      { name: 'Paracetamol 500mg (10 tabs)', brand: 'Biogesic', price: 45, category: 'Pharmacy', stock: 200 },
      { name: 'Alcohol 70% (500ml)', brand: 'Green Cross', price: 95, category: 'Pharmacy', stock: 150 },
      { name: 'Vitamin C 500mg (30 caps)', brand: 'Fern-C', price: 180, category: 'Supplements', stock: 120 },
      { name: 'Multivitamins (60 tabs)', brand: 'Centrum', price: 420, category: 'Supplements', stock: 80 },
      { name: 'Digital Thermometer', price: 250, category: 'Medical Supplies', stock: 60 },
      { name: 'Surgical Face Masks (50 pcs)', price: 150, category: 'Medical Supplies', stock: 100 },
    ],
  },
  {
